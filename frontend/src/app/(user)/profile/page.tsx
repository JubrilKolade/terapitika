          ...
          <Card className="md:col-span-1 bg-white/5 border-white/10 backdrop-blur-xl h-fit">
            <CardContent className="p-6 text-center">
              ...
              <div className="mt-8 space-y-2">
                ...
                <Button variant="ghost" className="w-full text-red-400 hover:text-red-300 hover:bg-red-400/10">
                  Delete Account
                </Button>
              </div>
            </CardContent>
          ...
          <div className="md:col-span-2 space-y-6">
            <Card className="bg-white/5 border-white/10 backdrop-blur-xl">
              ...
              <CardContent className="space-y-4">
                ...
                <Button className="bg-gradient-to-r from-therapy-500 to-calm-500">Update Profile</Button>
              </CardContent>
            </Card>

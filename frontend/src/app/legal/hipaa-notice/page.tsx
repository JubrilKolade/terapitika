    ...
    <div className="min-h-screen bg-[#0A0A0F] text-white">
      ...
      <main className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-6">
        ...
        <p className="text-sm text-gray-400">
          This placeholder notice describes how protected health information may be
          used and disclosed by Terapitika and how you can access this
          information. Replace this placeholder text with your final legal HIPAA
          notice before going live with real patient data.
        </p>
      </main>

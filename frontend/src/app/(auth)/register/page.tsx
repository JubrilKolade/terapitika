              ...
              <div className="flex items-center justify-between mb-8">
                {[1, 2].map((s) => (
                  <div key={s} className="flex items-center flex-1">
                    ...
                    {s < 2 && (
                      <div className={`flex-1 h-1 mx-2 rounded-full transition-all ${step > s ? 'bg-gradient-to-r from-therapy-500 to-calm-500' : 'bg-white/5'
                        }`} />
                    )}
                  </div>
                ))}
                ...
                {step === 1 ? (
                  ...
                  <>
                    ...
                    <div className="flex space-x-3">
                      ...
                      <Button
                        type="submit"
                        disabled={isLoadingAuth || !formData.acceptTerms}
